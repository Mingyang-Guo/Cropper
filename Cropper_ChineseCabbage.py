...
train_dir = "D:/FYPdataset/Unique2/Cabbage/Train"
val_dir = "D:/FYPdataset/Unique2/Cabbage/Valid"
test_dir = "D:/FYPdataset/Unique2/Cabbage/Test"

class_names = ['chinese_healthy','chinese_botanicalLeafSpot']
labels = ['chinese_healthy','chinese_botanicalLeafSpot']
...
for epoch in tqdm(range(num_epochs)):
    ...
    if val_loss < best_val_loss:
        ...
        patience_counter = 0
        torch.save(model.state_dict(), 'best_model_ChineseCabbage_SUM_loss.pth')
    else:
        patience_counter += 1
...
def plot_confusion_matrix(model, test_loader):
    ...
    class_labels = ['chinese_healthy','chinese_botanicalLeafSpot']
...
# Test Evaluation
model.load_state_dict(torch.load('best_model_ChineseCabbage_SUM_loss.pth'))
