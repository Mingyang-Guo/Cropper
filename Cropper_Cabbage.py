...
train_dir = "D:/FYPdataset/Unique2/Cabbage2/Train"
val_dir = "D:/FYPdataset/Unique2/Cabbage2/Valid"
test_dir = "D:/FYPdataset/Unique2/Cabbage2/Test"

class_names = ['cabbage_healthy','cabbage_CP_deficiency']
labels = ['cabbage_healthy','cabbage_CP_deficiency']
...
for epoch in tqdm(range(num_epochs)):
    ...
    if val_loss < best_val_loss:
        ...
        patience_counter = 0
        torch.save(model.state_dict(), 'best_model_Cabbage_SUM_loss.pth')
    else:
        patience_counter += 1
...
# Test Evaluation
model.load_state_dict(torch.load('best_model_Cabbage_SUM_loss.pth'))
