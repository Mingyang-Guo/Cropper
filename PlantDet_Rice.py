...
auroc = roc_auc_score(generator_test.classes, Y_pred, multi_class='ovr', average='macro')
print(f"Test AUROC: {auroc}")
y_pred = np.argmax(Y_pred, axis=1)


print(classification_report(generator_test.classes, y_pred, target_names=labels))
