...
# Input your address of dataset
train_dir = ""
val_dir = ""
test_dir = ""
labels = ['Bacterial Leaf Spot', 'Downy Mildew', 'Healthy Leaf', 'Mosaic Disease', 'Powdery_Mildew']
class_names = ['Bacterial Leaf Spot', 'Downy Mildew', 'Healthy Leaf', 'Mosaic Disease', 'Powdery_Mildew']
...
for epoch in tqdm(range(num_epochs)):
    ...
    if val_loss < best_val_loss:
        ...
        patience_counter = 0
        torch.save(model.state_dict(), 'Pumpkin.pth')
    else:
        patience_counter += 1
...
model.load_state_dict(torch.load('Pumpkin.pth'))
print("\n" + "=" * 70)
